#!/usr/bin/env python
# rename to nash-exchange.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/nash-exchange/")
...
print("nash-exchange $" + str(usd) + " | iconName=invest-applet")
print("---")
